...
class CalculatorApp:
    ...
    def create_ui(self):
        ...
        self.solution_entry = tk.Entry(self.root, textvariable=self.solution, font=('Helvetica', 20), bd=10, insertwidth=4, borderwidth=6, bg='black', fg='white')
        ...
        # Create buttons and adjust the layout with grey background and white text
        ...
        # Load and set the icon image using PIL
